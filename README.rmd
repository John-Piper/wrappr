...
wrappr is a collection of wrapper functions to use on other R functions to add extra functionality and support cleaner code.

Here is a biref description of some functionality the wrappr package has to offer:
